...
public class PostgresIntegrationTests {
	...
	void testFindAllVets() {
		// Ensure the findAll operation works as expected
		vets.findAll();
		// Test caching behavior explicitly (if needed)
		...
		public void printProperties() {
			for (EnumerablePropertySource<?> source : findPropertiesPropertySources()) {
				...
				for (String name : names) {
					...
					assertNotNull(String.valueOf(sourceProperty), "source property was expecting an object but is null.");
