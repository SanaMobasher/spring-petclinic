...
import org.junit.jupiter.api.BeforeEach; // Added to initialize Pageable
...
import org.springframework.data.domain.PageRequest; // Added for Pageable
...
class ClinicServiceTests {
	...
	void setUp() {
		// Initialize Pageable
		pageable = PageRequest.of(0, 5);  // Adjust page size as needed
	}
